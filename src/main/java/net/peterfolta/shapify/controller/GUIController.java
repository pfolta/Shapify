...
import net.peterfolta.shapify.view.about.AboutStage;
import net.peterfolta.shapify.view.exportbitmap.ExportBitmapStage;
import net.peterfolta.shapify.view.main.MainWindow;
import net.peterfolta.shapify.view.main.eventhandlers.*;
import net.peterfolta.shapify.view.newdrawing.NewDrawingStage;
