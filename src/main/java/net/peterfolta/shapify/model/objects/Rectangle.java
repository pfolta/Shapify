package net.peterfolta.shapify.model.objects;

import javafx.scene.paint.Color;
import javafx.scene.transform.Transform;
import net.peterfolta.shapify.controller.SvgController;
import net.peterfolta.shapify.util.ColorUtils;
import net.peterfolta.shapify.util.ShapeUtils;
